<%@ Control Language="C#" AutoEventWireup="true" CodeFile="InvoicePrint.ascx.cs"
    Inherits="Windows_InvoicePrint" %>
<style type="text/css">
    #tbl
    {
        width: 50%;
...
<div class="row">
    <div class="col-md-12 text-center">
        <div class="form-group">
            ...
            <asp:Button ID="btnEdit" runat="server" Text="Edit" class="btn btn-default" 
